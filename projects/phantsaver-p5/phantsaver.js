angular.module('projects').controller('PhantSaverCtrl', function($scope) {
	...
	var sketch = function(phant) {
		...
		phant.preload = function() {
			elephantHead = phant.loadImage("projects/phantsaver-p5/Resources/ElephantHead.png");
  			elephantTrunk = phant.loadImage("projects/phantsaver-p5/Resources/TrunkPart.png");
  			HucciSymbol = phant.loadImage("projects/phantsaver-p5/Resources/HucciRoseGold.png");
		}
